function graphScroll() {
  ...
  function reposition(){
    //var i1 = d3.bisectRight(sectionPos, pageYOffset + 0 - containerStart)
    var i1 = 0
    ...
    // sections.style('color', function(d, i){
    //   return sectionPos[i] < pageYOffset - containerStart + 200 ? 'red' : 'blue'
    // })
  ...
  function resize(){
    ...
    // console.log(belowStart, pageYOffset)
  }
