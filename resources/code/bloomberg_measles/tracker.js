...
(function() {
  ...
  var adcode = (config.ad_code) ? config.ad_code : '/5262/business/news/graphics';
  ...
  var new_leader = '<iframe width="728" height="90" id="lb_ad_frame" style="visibility:hidden;"' +
      ...
      'http://www.bloomberg.com/graphics/assets/ad.html?url=' + slug + "&size=728x90&position=top&iu="+adcode;

  for (var i=0; i< ads.length; i++){
      ads[i].style.display = "block";
      var randValue = new String(Math.random()).substring(2,11);
      var n = i + 1;
      ads[i].innerHTML = new_leader + Math.min(n ,2) + '&tile=' + n + '&ord=' + randValue + '"></iframe>';
  }
})()
